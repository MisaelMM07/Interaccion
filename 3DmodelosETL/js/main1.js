...
function init() {
    ...
    loader.load( '../src/stl/slotted_disk.stl', function ( geometry ) {
    ...
    loader.load( '../src/stl/pr2_head_pan.stl', function ( geometry ) {
    ...
    loader.load( '../src/stl/pr2_head_tilt.stl', function ( geometry ) {
    ...
    // Colored binary STL
    loader.load( '../src/stl/colored.stl', function ( geometry ) {
